...
class WeDevs_Settings_API {
    ...
    function admin_enqueue_scripts() {
        ...
        wp_enqueue_style( 'admin-pine',plugins_url()  .'/excellent-woocomerce-product-gallery/assets/admin.css');
        wp_enqueue_media();
    ...
    function callback_checkbox( $args ) {
        ...
        $html  .= sprintf( '<input class="betterdocs-settings-field" type="checkbox"  id="wpuf-%1$s[%2$s]" name="%1$s[%2$s]" value="true" %3$s />', $args['section'], $args['id'], checked( $value, 'true', false ) );
